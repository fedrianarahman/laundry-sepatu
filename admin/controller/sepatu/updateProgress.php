...
// mengupdate status
$query = mysqli_query($conn, "INSERT INTO `progress_sepatu`(`id`, `kode_sepatu`, `pemilik`, `no_hp_pemilik`, `merk_sepatu`, `warna`, `jenis_layanan`, `status`, `created_at`, `updated_at`) VALUES ('','$kode_sepatu','$pemilik','$no_hp_pemilik','$jenisSepatu','$warna','$jenis_layanan','$status','$created_at','$updated_at')");
